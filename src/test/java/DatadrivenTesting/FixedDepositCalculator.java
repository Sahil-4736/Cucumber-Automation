...
public class FixedDepositCalculator {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		for(int i=1;i<=rows;i++)
		{
			...
			String princ=ExcelUtility.getCellData(file,"Sheet1",i,0);
			String rateofinterest=ExcelUtility.getCellData(file,"Sheet1",i,1);
			String per1=ExcelUtility.getCellData(file,"Sheet1",i,2);
			String per2=ExcelUtility.getCellData(file,"Sheet1",i,3);
			String fre=ExcelUtility.getCellData(file,"Sheet1",i,4);
			String exp_mvalue=ExcelUtility.getCellData(file,"Sheet1",i,5);
			...
			if(Double.parseDouble(exp_mvalue)==Double.parseDouble(act_mvalue))
			{
				...
				ExcelUtility.fillGreenColor(file, "Sheet1",i,7);
			}
			else
			{
				System.out.println("Test Failed");
				ExcelUtility.setCellData(file, "Sheet1",i,7,"Failed");
				ExcelUtility.fillRedColor(file, "Sheet1",i,7);
			}
			Thread.sleep(3000);
