...
ChromeDriver driver;
	...
	void testLogin()
	{
		try
		{
			...
			Thread.sleep(3000);
			driver.findElement(By.xpath("//input[@id='Email']")).sendKeys("rabbit123@gmail.com");
			driver.findElement(By.xpath("//input[@id='Password']")).sendKeys("Sahil1234");
			driver.findElement(By.xpath("//button[normalize-space()='Log in']")).click();
			Thread.sleep(3000);
			//validation
			boolean status=driver.findElement(By.linkText("My account")).isDisplayed();
			Assert.assertEquals(true,true); // this makes testmethod fail
		}
		catch(Exception e)
		{
